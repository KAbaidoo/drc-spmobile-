    ...
    override suspend fun doWork(): Result {
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                val itemDeferrable = async { getItem(id) }
            ...
            item.apply {
                repository.uploadHousehold(
                    ...
                    HouseholdPayload(
                        ...
                        household_head_sex = MapUtil.stringMapping[item.household_head_sex],
                        ...
                        household_migration_status = MapUtil.intMappings[item.household_migration_status]
                            ?: 160,
                        ...
                        occupation_status_of_current_accommodation = MapUtil.intMappings[item.occupation_status_of_current_accommodation]
                            ?: 75,
                        other_occupation_status_of_current_accommodation = item.other_occupation_status_of_current_accommodation,
                        main_material_of_exterior_walls = MapUtil.intMappings[item.main_material_of_exterior_walls]
                            ?: 91,
                        ...
                        type_of_fuel_used_for_household_cooking = MapUtil.intMappings[item.type_of_fuel_used_for_household_cooking]
                            ?: 114,
                        other_type_of_fuel_used_for_household_cooking = item.other_type_of_fuel_used_for_household_cooking,
                        main_source_of_household_drinking_water = MapUtil.intMappings[item.main_source_of_household_drinking_water]
                            ?: 129,
                        other_main_source_of_household_drinking_water = item.other_main_source_of_household_drinking_water,
                        type_of_household_toilet = MapUtil.intMappings[item.type_of_household_toilet]
                            ?: 161,
                        other_type_of_household_toilet = item.other_type_of_household_toilet,
                        method_of_waste_disposal = MapUtil.intMappings[item.method_of_waste_disposal]
                            ?: 144,
                        ...
                        is_income_regular = MapUtil.stringMapping[item.is_income_regular],
                        bank_account_or_bank_card_available = MapUtil.stringMapping[item.bank_account_or_bank_card_available],
                        mobile_money_username = item.mobile_money_username,
                        mobile_money_phone_number = item.mobile_money_phone_number,
                        household_member_access_to_cultivable_land = MapUtil.stringMapping[item.household_member_access_to_cultivable_land],
                        household_member_owner_of_cultivable_land = MapUtil.stringMapping[item.household_member_owner_of_cultivable_land],
                        ...
                        practice_of_cash_crop_farming_or_commercial_farming = MapUtil.stringMapping[item.practice_of_cash_crop_farming_or_commercial_farming],
