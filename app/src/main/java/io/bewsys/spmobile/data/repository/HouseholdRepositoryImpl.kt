...
class HouseholdRepositoryImpl(db: Database) : HouseholdRepository {

    private val queries = db.householdQueries

    override suspend fun getAllHouseholds(): Flow<List<Household>> =
        queries.getAllHousholds().asFlow().mapToList(context = Dispatchers.Default)


    override suspend fun getHousehold(id: Long): Household? =
        withContext(Dispatchers.IO) {
            queries.getById(id).executeAsOneOrNull()
        }

    override suspend fun insertHousehold(
        ...
        household.apply {
            queries.insertHousehold(
                ...
                amount_of_cultivable_land_owned = amount_of_cultivable_land_owned, days_spent_begging_coping_strategy = days_spent_begging_coping_strategy,
                ...
                days_spent_consume_wild_food_coping_strategy = days_spent_consume_wild_food_coping_strategy, days_spent_days_without_eating_coping_strategy = days_spent_days_without_eating_coping_strategy,
                days_spent_eat_less_expensively_coping_strategy = days_spent_eat_less_expensively_coping_strategy, days_spent_reduce_amount_consumed_coping_strategy = days_spent_reduce_amount_consumed_coping_strategy,
