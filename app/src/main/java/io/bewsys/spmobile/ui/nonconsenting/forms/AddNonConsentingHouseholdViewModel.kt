...
import io.bewsys.spmobile.data.NonConsentingHousehold
import io.bewsys.spmobile.ui.ADD_NON_CONSENTING_HOUSEHOLD_RESULT_OK
import kotlinx.coroutines.channels.Channel
import kotlinx.coroutines.flow.receiveAsFlow
import kotlinx.coroutines.launch

class AddNonConsentingHouseholdViewModel(private val state: SavedStateHandle) : ViewModel() {
    ...
    private fun addNonConsentingHousehold(newNonConsentingHousehold: NonConsentingHousehold) =
